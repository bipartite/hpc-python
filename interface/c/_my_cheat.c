...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 10), // void()(double *, double *, int, int, double, double, double, double)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 5), // double *
...
static void _cffi_d_evolve(double * x0, double * x1, int x2, int x3, double x4, double x5, double x6, double x7)
{
  evolve(x0, x1, x2, x3, x4, x5, x6, x7);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_evolve(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "evolve", 8, 8, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6, &arg7))
    return NULL;
...
#else
#  define _cffi_f_evolve _cffi_d_evolve
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "evolve", (void *)_cffi_f_evolve, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_evolve },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__my_cheat(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__my_cheat(void) { return NULL; }
#  else
     init_my_cheat(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit__my_cheat(void)
{
  return _cffi_init("_my_cheat", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_my_cheat(void)
{
  _cffi_init("_my_cheat", 0x2601, &_cffi_type_context);
}
#endif
